...
class CardCreationCheckout(Base):
    ...
    chosen_preview_index: Mapped[int | None] = mapped_column(Integer, nullable=True)
    repick_purchased: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
...
class Card(Base):
    ...
    rarity: Mapped[str] = mapped_column(String(40), nullable=False, default="standard")
    rarity_template: Mapped[int] = mapped_column(Integer, default=1, nullable=False)
